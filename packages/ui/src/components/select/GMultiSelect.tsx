...
interface MultiSelectProps<OptionType> extends Select2Props<
  OptionType,
  true,
    ...
    >
      ...
      <Select<OptionType, true, GroupBase<OptionType>>
        ...
        classNames={{
          ...
          multiValue: () => twMerge('!bg-orange-100 !rounded-md !m-0'),
          multiValueLabel: () => twMerge('!text-orange-700 !text-xs !p-1 !px-2'),
          multiValueRemove: () =>
            twMerge(
              '!text-orange-700 hover:!bg-orange-200 hover:!text-orange-800 !rounded-r-md !px-1 !cursor-pointer'
            ),
        }}
        styles={{
          container: (provided) => ({
