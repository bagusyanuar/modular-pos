...
console.log(`✅ Modul @genpos/${name} berhasil dibuat!`);

// Install hanya untuk modul yang baru dibuat
console.log(`📦 Installing dependencies untuk @genpos/${name}...`);
execSync(`pnpm install --filter @genpos/${name}`, { stdio: 'inherit' });

console.log(`\n🚀 Selesai! Modul @genpos/${name} siap digunakan.`);
